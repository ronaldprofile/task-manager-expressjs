...
import { getCookie, extractTokenFromCookies } from "./helpers/auth.js";
...
describe("Integration: Auth", () => {
  describe("[POST] /auth/register", () => {
    ...
    it("should return a signed JWT token in httpOnly cookie on successful register", async () => {
      ...
      const tokenCookie = getCookie(response.headers["set-cookie"], "token");
